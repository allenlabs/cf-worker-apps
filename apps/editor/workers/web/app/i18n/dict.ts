...
const editor: Dict = {
  en: {
    ...
    // AI assist (bubble toolbar + slash items)
    'ai.label': 'AI',
    'ai.ask': 'Ask AI',
    'ai.improve': 'Improve writing',
    'ai.fixGrammar': 'Fix spelling & grammar',
    'ai.shorter': 'Make shorter',
    'ai.longer': 'Make longer',
    'ai.summarize': 'Summarize',
    'ai.explain': 'Explain',
    'ai.changeTone': 'Change tone to professional',
    'ai.translateEn': 'Translate to English',
    'ai.translateKo': 'Translate to Korean',
    'ai.cancel': 'Cancel',
    ...
    'ai.discard': 'Discard',
    'ai.slashAsk': 'Ask AI',
    'ai.slashAskHint': 'Write or generate with AI',
    'ai.promptLabel': 'Ask AI to write…',
  ...
  ko: {
    ...
    'ai.ask': 'AI에게 묻기',
    'ai.improve': '문장 다듬기',
    'ai.fixGrammar': '맞춤법·문법 교정',
    'ai.shorter': '짧게 만들기',
    'ai.longer': '길게 만들기',
    'ai.summarize': '요약하기',
    'ai.explain': '설명하기',
    'ai.changeTone': '정중한 어조로 바꾸기',
    'ai.translateEn': '영어로 번역',
    'ai.translateKo': '한국어로 번역',
    'ai.cancel': '취소',
    'ai.thinking': '생각 중…',
    'ai.error': 'AI 요청에 실패했습니다.',
    'ai.replace': '선택 영역 교체',
    'ai.insertBelow': '아래에 삽입',
    'ai.discard': '버리기',
    'ai.slashAsk': 'AI에게 묻기',
    'ai.slashAskHint': 'AI로 작성하거나 생성',

...
// switch is instant AND propagates to every other Allen Labs app on the next
...
// (editor.allenlabs.org → .allenlabs.org), which the browser allows. No
// round-trip needed.
        ...
        return (
          <button
            ...
            className={`px-1.5 py-0.5 rounded ${
              active ? 'bg-white/25 text-white' : 'text-white/70 hover:bg-white/15'
            }`}
          >
            {loc === 'ko' ? '한' : 'EN'}
          </button>
